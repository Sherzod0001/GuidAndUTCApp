    ...
    public class DateFinder
    {
        public void FindUtcNow()
        {
            ...
            do
            {
                ...
                Console.WriteLine($"Current UTC time: {utcNowString}");

                try
                {
                    ClipboardService.SetText(utcNowString);
                    Console.WriteLine("The time has been copied to the clipboard.");
                }
                catch (Exception ex)
                {
                ...
                Console.WriteLine("Enter 'yes' or 'y' to continue, otherwise the program will exit");
